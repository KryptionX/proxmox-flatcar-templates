...
- NFS storage mounts (thanosDirect server with specific paths)
...
✅ **NFS mounts work identically** to current setup  
✅ **Portainer compatibility** unchanged  
...
3. **Use NFS analysis prompt** (see `docker-nfs-analysis-prompt.md`) to extract existing mounts
